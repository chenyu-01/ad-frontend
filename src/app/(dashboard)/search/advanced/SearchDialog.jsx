...
import InputLabel from "@/app/(dashboard)/search/advanced/InputLabel";
import CheckBoxLabel from "@/app/(dashboard)/search/advanced/CheckBoxLabel";
import SelectLabel from "@/app/(dashboard)/search/advanced/SelectLabel";
import "./mydialog.css";
