...
const Siderbar = ({ onPageChange}) =>{
    ...
    <nav>                                         
        <button className="home">
            <div>
                <div className="icon" >
                <svg className="house" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
                        <g className="outline">
                    ...
                    <svg className="feather left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 7" >
                    ...
                    <svg className="feather right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 7" >
        ...
        <button className="messages">
            <div>
                <div className="icon">
                    <div className="top">
                        <svg className="default"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 13">
                        ...
                        <svg className="inner" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 13">
        ...
        <button onClick={() => handleButtonClick('list')} className="lists">
            <div>
                <div className="icon">
                    <svg className="pencil"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 22">
                    ...
                    <svg className="list" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
